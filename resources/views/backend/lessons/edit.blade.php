        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-12 col-lg-9 form-group">
                    {!! Form::label('position', trans('labels.backend.lessons.fields.position').'*', ['class' => 'control-label']) !!}
                    {!! Form::number('position', old('position'), ['class' => 'form-control', 'placeholder' => trans('labels.backend.lessons.fields.title')]) !!}
                </div>
