                ...
                <div id="general" class="tab-pane container active">
                    <div class="row mt-4 mb-4">
                        <div class="col ">
                            ...
                            <div class="form-group row">
                                {{ html()->label(__('labels.backend.general_settings.certificate'))->class('col-md-2 form-control-label')->for('custom_js') }}

                                <div class="col-md-10">
                                    <div class="form-group row">
                                        {{ html()->label(__('labels.backend.teachers.fields.color'))->class('col-md-12 form-control-label')->for('certificate_color') }}
                                        <div class="col-md-12">
                                            {{ html()->text('certificate_color')
                                                    ->class('form-control')
                                                    ->placeholder('#FFFFFF')
                                                     ->value(config('certificate_color'))}}
                                        </div><!--col-->
                                    </div>

                                    <div class="form-group row">
                                        {{ html()->label(__('labels.backend.teachers.fields.logo'))->class('col-md-12 form-control-label')->for('certificate_logo') }}

                                        <div class="col-md-12">
                                            {!! Form::file('certificate_logo', ['class' => 'form-control d-inline-block', 'placeholder' => '', 'accept' => 'image/jpeg,image/gif,image/png', 'data-preview'=>'#certificate_logo_image_preview']) !!}
                                        </div><!--col-->
                                        <div class="col-md-12">
                                            <div id="certificate_logo_image_preview" class="d-inline-block m-3 p-3 preview">
                                                <img height="50px" src="{{asset('storage/logos/'.config('certificate_logo'))}}">
                                            </div>
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        {{ html()->label(__('labels.backend.teachers.fields.background'))->class('col-md-12 form-control-label')->for('certificate_background') }}

                                        <div class="col-md-12">
                                            {!! Form::file('certificate_background', ['class' => 'form-control d-inline-block', 'placeholder' => '', 'accept' => 'image/jpeg,image/gif,image/png', 'data-preview'=>'#certificate_background_image_preview']) !!}
                                        </div><!--col-->

                                        <div class="col-md-12">
                                            <div id="certificate_background_image_preview" class="d-inline-block m-3 p-3 preview">
                                                <img height="100px" src="{{asset('storage/logos/'.config('certificate_background'))}}">
                                            </div>
                                        </div>
                                    </div>
                                </div><!--col-->
                ...
                <div id="payment_settings" class="tab-pane container fade">
                    <div class="row mt-4 mb-4">
                        <div class="col">
                            ...
                            <div class="form-group row">
                                {{ html()->label(__('labels.backend.general_settings.payment_settings.tap_payment'))->class('col-md-3 form-control-label')->for('services.tap_payment.active') }}
                                <div class="col-md-9">
                                    <div class="checkbox">
                                        {{ html()->label(
                                                html()->checkbox('services__tap__active', config('services.tap_payment.active') ? true : false,1)
                                                      ->class('switch-input')->value(1)
                                                . '<span class="switch-label"></span><span class="switch-handle"></span>')
                                    ...
                                    <small>
                                        <i> {{ __('labels.backend.general_settings.payment_settings.tap_payment_note')}}</i>
                                    </small>
                                    <div class="switch-content @if(config('services.tap_payment.active') == 0 || config('services.tap_payment.active') == false) d-none @endif">
                                        <br>
                                        <div class="form-group row">
                                            {{ html()->label(__('labels.backend.general_settings.payment_settings.secret_key'))->class('col-md-2 form-control-label')->for('services.tap_payment.secret_key') }}
                                            <div class="col-md-8 col-xs-12">
                                                {{ html()->text('services__tap__secret')
                                                     ->class('form-control')
                                                     ->value(config('services.tap_payment.secret_key'))
                                                     }}
                                            </div><!--col-->
                                        </div><!--form-group-->
                                        <div class="form-group row">
                                            {{ html()->label(__('labels.backend.general_settings.payment_settings.public_key'))->class('col-md-2 form-control-label')->for('services.tap_payment.public_key') }}
                                            <div class="col-md-8 col-xs-12">
                                                {{ html()->text('services__tap__public')
                                                     ->class('form-control')
                                                     ->value(config('services.tap_payment.public_key'))
                                                     }}
                                            </div><!--col-->
                                        </div><!--form-group-->
                                        <div class="form-group row">
                                            {{ html()->label(__('labels.backend.general_settings.payment_settings.encryption_key'))->class('col-md-2 form-control-label')->for('services.tap_payment.encryption_key') }}
                                            <div class="col-md-8 col-xs-12">
                                                {{ html()->textarea('services__tap__encryption')
                                                     ->class('form-control')
                                                     ->value(config('services.tap_payment.encryption_key'))
                                                     }}
                                            </div><!--col-->
                                        </div><!--form-group-->
                                    </div>
