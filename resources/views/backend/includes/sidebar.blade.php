        ...
        <ul class="nav">
            ...
            <li class="nav-item nav-dropdown">
                <a class="nav-link nav-dropdown-toggle" href="#">
                    <i class="nav-icon icon-calendar"></i> @lang('menus.backend.sidebar.appointments.title')
                </a>
                @can('service_category_access')
                <ul class="nav-dropdown-items">
                    <li class="nav-item">
                        <a class="nav-link {{ $request->segment(2) == 'service_categories' ? 'active' : '' }}"
                           href="{{ route('admin.service_categories.index') }}">
                            <span class="title">@lang('menus.backend.sidebar.service_categories.title')</span>
                        </a>
                    </li>
                </ul>
                @endcan
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ $request->segment(2) == 'appointments' ? 'active' : '' }}"
                           href="{{ route('admin.appointments.index') }}">
                            <span class="title">@lang('menus.backend.sidebar.appointments.title')</span>
                        </a>
                    </li>
                </ul>
                @endcan
                    ...
                    <li class="nav-item ">
                        <a class="nav-link {{ $request->segment(2) == 'services' ? 'active' : '' }}"
                           href="{{ route('admin.services.index') }}">
                            <span class="title">@lang('menus.backend.sidebar.services.title')</span>
                        </a>
                    </li>
                </ul>
                @endcan
                        ...
                        <ul class="nav-dropdown-items">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link {{ $request->segment(1) == 'teachers' ? 'active' : '' }}"
                                   href="{{ route('admin.reports.teachers') }}">@lang('menus.backend.sidebar.reports.teachers')
                                </a>
                            </li>
                            <li class="nav-item ">
