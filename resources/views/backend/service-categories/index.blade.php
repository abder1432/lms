                    ...
                    <div class="table-responsive">
                        <div class="d-block">
                            <ul class="list-inline">
                                ...
                                |
                                <li class="list-inline-item">
                                    <a href="{{ route('admin.service_categories.index') }}?show_deleted=1"
                        ...
                        <table id="myTable"
                            ...
                            <tr>
                                ...
                                <th>@lang('labels.backend.service_categories.fields.services')</th>
                                @if( request('show_deleted') == 1 )
...
@push('after-scripts')
    <script>
        $(document).ready(function () {
            var route = '{{route('admin.service_categories.get_data')}}';

            @if(request('show_deleted') == 1)
                route = '{{route('admin.service_categories.get_data',['show_deleted' => 1])}}';
            @endif
            ...
            @can('category_access')
            @if(request('show_deleted') != 1)
            $('.actions').html('<a href="' + '{{ route('admin.service_categories.mass_destroy') }}' + '" class="btn btn-xs btn-danger js-delete-selected" style="margin-top:0.755em;margin-left: 20px;">Delete selected</a>');
            @endif
            @endcan
