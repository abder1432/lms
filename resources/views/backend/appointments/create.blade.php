        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-3 form-group">
                    ...
                    {!! Form::date('date', old('date'), ['class' => 'form-control', 'placeholder' => trans('labels.backend.appointments.fields.date'), 'required' => true]) !!}
                </div>
                <div class="col-12 col-lg-3 form-group">
                    {!! Form::label('time', trans('labels.backend.appointments.fields.time'), ['class' => 'control-label']) !!}
                    {!! Form::time('time', old('time'), ['class' => 'form-control', 'placeholder' => trans('labels.backend.appointments.fields.time'), 'required' => true]) !!}
                </div>
            </div>
