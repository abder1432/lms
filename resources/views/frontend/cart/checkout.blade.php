            ...
            <div class="checkout-content">
                ...
                <div class="row">
                    <div class="col-md-9">
                        ...
                        @if(count($courses) > 0)
                            @if((config('services.stripe.active') == 0) && (config('paypal.active') == 0) && (config('payment_offline_active') == 0) && (config('services.tap_payment.active') == 0))
                            ...
                            @else
                                <div class="order-payment">
                                    ...
                                    <div id="accordion">
                                        @if(config('services.tap_payment.active') == 1)
                                            <div class="payment-method w-100 mb-0">
                                                ...
                                                <div class="check-out-form collapse show" id="collapsePaymentOne"
                                                    ...
                                                    <form accept-charset="UTF-8"
                                                        ...
                                                        <input id="card_token" name="card_token" type="hidden" value=""/>
                                                        <!-- Tap pay button -->
                                                        <button type="submit"
                                                                id="tap-btn"
...
@push('after-scripts')
    @if(config('services.tap.active') == 1)
        <script src="https://cdnjs.cloudflare.com/ajax/libs/bluebird/3.3.4/bluebird.min.js"></script>
        <script src="https://secure.gosell.io/js/sdk/tap.min.js"></script>
        <script>
            $(document).ready(function () {
                //pass your public key from tap's dashboard
                var tap = Tapjsli('{{config('services.tap_payment.public_key')}}');
                ...
                form.addEventListener('submit', function(event) {
                    ...
                    tap.createToken(card).then(function(result) {
                        ...
                        if (result.error) {
                            ...
                            var tokenElement = document.getElementById('card_token');
                            tokenElement.value = result.id;
                            tokenElement.value && form.submit();
