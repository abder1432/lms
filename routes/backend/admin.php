...
Route::group(['middleware' => 'role:administrator'], function () {
    ...
    Route::get('/teacher/{teacher}/availability', ['uses' => 'Admin\TeachersController@availability', 'as' => 'teachers.availability']);
    Route::post('/teacher/{teacher}/availability', ['uses' => 'Admin\TeachersController@updateAvailability', 'as' => 'teachers.update_availability']);
    ...
    //===== Appointments Routes =====//
    Route::get('appointment/create', ['uses' => 'Admin\AppointmentsController@create', 'as' => 'appointment.create']);
    Route::get('appointment/{appointment}/edit', ['uses' => 'Admin\AppointmentsController@edit', 'as' => 'appointment.edit']);
    Route::put('appointment/{appointment}', ['uses' => 'Admin\AppointmentsController@update', 'as' => 'appointment.update']);
    Route::post('appointment', ['uses' => 'Admin\AppointmentsController@store', 'as' => 'appointments.store']);
    Route::delete('appointment/{appointment}', ['uses' => 'Admin\AppointmentsController@destroy', 'as' => 'appointments.destroy']);
    Route::post('appointments_mass_destroy', ['uses' => 'Admin\AppointmentsController@massDestroy', 'as' => 'appointments.mass_destroy']);
    Route::post('appointments/complete', ['uses' => 'Admin\AppointmentsController@complete', 'as' => 'appointments.complete']);
    Route::delete('appointments_perma_del/{id}', ['uses' => 'Admin\AppointmentsController@perma_del', 'as' => 'appointments.perma_del']);

    //===== Service Categories Routes =====//
    Route::resource('service_categories', 'Admin\ServiceCategoriesController');
    Route::get('get-service_categories-data', ['uses' => 'Admin\ServiceCategoriesController@getData', 'as' => 'service_categories.get_data']);
    Route::post('service_categories_mass_destroy', ['uses' => 'Admin\ServiceCategoriesController@massDestroy', 'as' => 'service_categories.mass_destroy']);
    Route::post('service_categories_restore/{id}', ['uses' => 'Admin\ServiceCategoriesController@restore', 'as' => 'service_categories.restore']);
    Route::delete('service_categories_perma_del/{id}', ['uses' => 'Admin\ServiceCategoriesController@perma_del', 'as' => 'service_categories.perma_del']);

    //===== Services Routes =====//
    Route::resource('services', 'Admin\ServicesController');
    Route::get('get-services-data', ['uses' => 'Admin\ServicesController@getData', 'as' => 'services.get_data']);
    ...
    Route::post('service-save-sequence', ['uses' => 'Admin\ServicesController@saveSequence', 'as' => 'services.saveSequence']);
    Route::get('service-publish/{id}', ['uses' => 'Admin\ServicesController@publish', 'as' => 'services.publish']);
...
Route::group(['middleware' => 'role:administrator|teacher'], function () {
    ...
    Route::get('get-teachers-reports-data', ['uses' => 'ReportController@getTeachersData', 'as' => 'reports.get_teachers_data']);
...
Route::get('appointments', ['uses' => 'Admin\AppointmentsController@index', 'as' => 'appointments.index']);
Route::get('appointment/{appointment}', ['uses' => 'Admin\AppointmentsController@show', 'as' => 'appointments.show']);
Route::get('get-appointments-data', ['uses' => 'Admin\AppointmentsController@getData', 'as' => 'appointments.get_data']);
