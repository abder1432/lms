...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::post('cart/tap-payment', ['uses' => 'CartController@tapPayment', 'as' => 'cart.tap.payment']);
    Route::get('cart/tap-payment/3ds', ['uses' => 'CartController@tap3DSPayment', 'as' => 'cart.tap.payment.3ds']);
...
// Appointments
Route::get('book-an-appointment', [AppointmentController::class, 'bookAppointment'])->name('book-appointment');
