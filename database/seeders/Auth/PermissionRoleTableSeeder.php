...
class PermissionRoleTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // Create Roles
        $admin = Role::updateOrCreate(['name' => config('access.users.admin_role')], ['name' => config('access.users.admin_role')]);
        $teacher = Role::updateOrCreate(['name' => 'teacher'],['name' => 'teacher']);
        $student = Role::updateOrCreate(['name' => 'student'],['name' => 'student']);
        ...
        $permissions = [
            ...
            ['id' => 89, 'name' => 'service_category_access',],
            ['id' => 90, 'name' => 'service_category_create',],
            ['id' => 91, 'name' => 'service_category_edit',],
            ['id' => 92, 'name' => 'service_category_view',],
            ['id' => 93, 'name' => 'service_category_delete',],

            ['id' => 94, 'name' => 'service_access',],
            ['id' => 95, 'name' => 'service_create',],
            ['id' => 96, 'name' => 'service_edit',],
            ['id' => 97, 'name' => 'service_view',],
            ['id' => 98, 'name' => 'service_delete',],

            ['id' => 99, 'name'  => 'appointment_access',],
            ['id' => 100, 'name' => 'appointment_create',],
            ['id' => 101, 'name' => 'appointment_edit',],
            ['id' => 102, 'name' => 'appointment_view',],
            ['id' => 103, 'name' => 'appointment_delete',],
        ];
